...
export const API_ENDPOINTS = {
  ...
  TRAINING: {
    ...
    START: (id: string) => `/api/training/${id}/start`,
    STOP: (id: string) => `/api/training/${id}/stop`,
    LOGS: (id: string) => `/api/training/${id}/logs`,
  },
} as const
